...
dat_17 <- read.csv('./data/qP_simp_17_190731.csv') # using new size classes from 2017 SD op-plan
dat_old <- read.csv('./data/qP_simp_oldSCs_190731.csv')# using the old pre-2017 size classes 
events <- read.csv('./data/events_190731.csv')
...
awl <- read.csv('./data/awl_shellfish_190731.csv') 
